...
import { postCapNhatLichHen } from "../../api/lichhen/lichhen";
import DatePicker from "react-datepicker";
import moment from "moment";
import { useNavigate } from "react-router-dom";

const PopupUpdateSchedule = ({handleClosePopup, data, selectedItem}) => {
    ...
    <PopupWrapper>
      <Form>
        ...
        <ButtonGroup>
          ...
          <Button className="btn-create" onClick={handleUpdateLH}>CẬP NHẬT</Button>
        </ButtonGroup>
      </Form>
    </PopupWrapper>
  </>)
...
export default PopupUpdateSchedule;
